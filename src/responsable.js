...
function Responsabilizate(){
    return(
        ...
        <div className="columna">
            ...
            <ul>
                <li>Test AA: mide las afinidades e inclinaciones del usuario, lo cual combinado con la región en la que le gustaría participar, devolverá (por medio de algoritmos ideados por nosotros) una serie de resultados recomendados.</li>
...
export default Responsabilizate;